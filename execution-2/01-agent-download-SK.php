<?
// https://ariefsan.basproject.online/telegram/execution-2/01-agent-download-SK.php
exit();
...
$msg = "NAMA PLANT;KODE DEPO;NAMA DEPO;TANGGAL JUAL;ESTIMATION STATUS;STATUS SENT SAP;NOMOR ESTIMASI;NOMOR PO;HAWKER ID;HAWKER NAME;KODE PRODUCT;NAMA PRODUCT;SHORT PRODUCT;QTY PO;CREATED TIME PO;QTY ALOKASI;QTY SELLING;QTY RETURN \n";
if(mysqli_num_rows($exec) > 0) {
    ...
    while($row = mysqli_fetch_array($exec)) {
  	...
  	file_put_contents("download/SK_INNDA.csv", $msg);
    
  	$filePath = 'download/SK_INNDA.csv';
