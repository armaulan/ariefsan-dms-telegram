<?
// https://ariefsan.basproject.online/telegram/execution-2/02-dist-download-SK.php
exit();
...
, a.estimate_order_number as `NOMOR ESTIMASI`
...
$msg = "NAMA PLANT;KODE DEPO;NAMA DEPO;TANGGAL JUAL;ESTIMATION STATUS;STATUS SENT SAP;NOMOR ESTIMASI;NOMOR PO;STORE ID;STORE NAME;KODE PRODUCT;NAMA PRODUCT;SHORT NAME;QTY PO;CREATED TIME PO;QTY ALOKASI;QTY DROP;QTY RETUR BAIK; QTY RETUR BS \n";
if(mysqli_num_rows($exec) > 0) {
    ...
    while($row = mysqli_fetch_array($exec)) {
  	...
  	file_put_contents("download/SK_INNDI.csv", $msg);
    
  	$filePath = 'download/SK_INNDI.csv';
