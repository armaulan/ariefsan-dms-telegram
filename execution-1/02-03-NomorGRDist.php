<?
// https://ariefsan.basproject.online/telegram/execution-1/02-03-NomorGRDist.php
...
, b.dn_date as `TANGGAL DN`
, a.received_date as `TANGGAL JUAL di GR`
, d.delivery_number as `NOMOR DN`
, b.total_quantity as `QTY PO`
...
left join goods_received_status e on e.status_id=a.status_id
left join (select 
    aa.gr_number
