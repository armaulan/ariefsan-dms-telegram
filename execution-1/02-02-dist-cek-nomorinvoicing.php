<?
// https://ariefsan.basproject.online/telegram/execution-1/02-02-dist-cek-nomorinvoicing.php
require '../00-02-conn-dist.php';

$sender = $_POST['let1'];
$url = $_POST['let3'];
$json = json_decode($_POST['let2']);
$nomorinvoicing = $json[1];
...
, fpi.nomor_seri_faktur_pajak as `NOMOR FAKTUR PAJAK`
, fpi.nomor_dokumen as `NOMOR DOKUMEN`
from dropping a
...
join faktur_pajak_invoice_detail fpid on fpid.invoice_id = b.tagihan_id
join faktur_pajak_invoice fpi on fpi.faktur_pajak_invoice_id = fpid.faktur_pajak_invoice_id 
where b.invoice_number = '$nomorinvoicing';
";
