<?
// https://ariefsan.basproject.online/telegram/execution-1/01-10-NomorPK.php
...
, (select format(arpl.cost_value,0) from agent_report_psak_log arpl 
...
, format(urdl.value_uk,0) as `UANG KEHADIRAN`
...
where f.penerimaan_kasir_number='$pknumber'
";
...
$msg = "#01-Agent (Status Selling sampai PK SB) \n \n";
