<?
# https://ariefsan.crewbasproject.my.id/telegram/execution-1/01-03-cekktp.php
...
if(mysqli_num_rows($exec) > 0) {
    ...
    while($row = mysqli_fetch_array($exec)) {
        ...
        $msg .= "Kode Depo: " . $row['KODE DEPO'] . "\n" .
                ...
                "Hawker: " . $row['NAMA HAWKER'] . "\n" .
          		"KTP: " . $row['NOMOR KTP'] . "\n" .
                "Bank: " . $row['NAMA BANK'] . "\n" .
                "Rek: " . $row['NOMOR REKENING'] . "\n" .
  				"Status: " . $row['STATUS'] . "\n".
          		"Onhand: " . $row['ONHAND'] . "\n".
          		"AR: " . $row['AR'] . "\n".
          		"First Trans: " . $row['FIRST TRANS'] . "\n".
          		"Last Trans: " . $row['LAST TRANS'] . "\n \n"
                ;
      }
