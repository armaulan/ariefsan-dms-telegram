<?
// https://ariefsan.basproject.online/telegram/execution-1/02-14-distdepo.php
...
and d.owner_id not in ('1','2','7','8','9')
or depo_code = '$value'
and d.owner_id not in ('1','2','7','8','9')
";
...
if(mysqli_num_rows($exec) > 0) {
  ...
  while($row = mysqli_fetch_array($exec)) {
        ...
        $msg .= "Depo ID: " . $row['DEPO ID'] . "\n" .
          		...
          		"Depo Code: " . $row['DEPO CODE'] . "\n" .
          		"Latitude: " . $row['LATITUDE'] . "\n" .
          		"Longitude: " . $row['LONGITUDE'] . "\n" .
          		"Sales Office ID: " . $row['OFFICE'] . "\n" .
          		"Ritase: " . $row['RITASE'] .  "\n \n"  
				;
      }
