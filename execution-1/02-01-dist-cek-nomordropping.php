<?
// https://ariefsan.basproject.online/telegram/execution-1/02-01-dist-cek-nomordropping.php
...
where a.dropping_number='$nomordropping';
";
...
$msg = "#02-Dist (Status Nomor Dropping) \n \n";
if(mysqli_num_rows($exec) > 0) {
    ...
    # $config["whatsappSendMessage"]($config['key-wa-bas'],  $msg , $config['id-wa-fighter'], "true");
    echo $output;
} 
