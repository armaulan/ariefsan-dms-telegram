<?
// https://ariefsan.basproject.online/telegram/execution-1/01-04-agent-cek-single-order1.php
...
$final_exec = function($data_query, $data_query2, $sender) {
...
$final_exec($data_query, $data_query2, $sender);
