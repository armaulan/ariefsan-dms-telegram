<?
# https://ariefsan.crewbasproject.my.id/telegram/execution-3/ticket/03-03-ticket-update.php
# require '../00-02-conn-dist.php';
require '00-connection.php';
require '../../00-03-base-config.php';
require '00-func-user.php';
$config = config();
$listUser = getListVendor();
...
if (in_array(strtolower($postData[2]),  ['done'] )){
...
$queryUpdate = "update ticket set status=2, done_time = '$done_time', pic_vendor = '$pic_vendor' where ticket_id = '$postData[1]' ";
