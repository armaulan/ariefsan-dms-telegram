...
and d.owner_id = 28
and sc.mainstore_id = 3
order by total ASC";

$exec = mysqli_query($conn, $sql) or die(mysqli_error($conn));
echo mysqli_num_rows($exec);

$msg = "*02-Dist (FLAG SKU CHANEL DEVELOPMENT COMMUNITY)* \n";
$msg2 = " \n \n";
$total = 0 ;
...
# print($dataMessage);
$filename = substr(str_shuffle('0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'),1 , 4). "_flagsku_CommunityNasional.txt";
...
$config["whacenterSendMessage"]($config['key-whacenter-1'], '081132214767', $msg . $msg2  ); # 081132214971
  
if ($writeResult != false) {
  $config["whacentersenddoc"]($config['key-whacenter-1'],  "081132214767", "", "https://ariefsan.crewbasproject.my.id/telegram/execution-3/download/". $filename);
}
