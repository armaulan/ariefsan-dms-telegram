<?
// https://ariefsan.crewbasproject.my.id/telegram/execution-3/03-dist-06-approvalsalesMTI.php
...
$msg = "*02-Dist (Flag SKU CHANEL DEVELOPMENT MTI)* \n";
$msg2 = " \n \n";
$total = 0 ;
...
$writeResult = file_put_contents("download/". $filename, $dataMessage);
    ...
    # $config["whatsappSendMessage"]($config['key-wa-bas'],  $msg , $config['id-wa-riky'], "false");
     $config["whacenterSendMessage"]($config['key-whacenter-1'], '081132214733', $msg . $msg2  );
  	 $config["whacenterSendMessage"]($config['key-whacenter-1'], '081132214783', $msg . $msg2  );
  
  if ($writeResult != false) {
  $config["whacentersenddoc"]($config['key-whacenter-1'],  "081132214783", "", "https://ariefsan.crewbasproject.my.id/telegram/execution-3/download/". $filename);
  $config["whacentersenddoc"]($config['key-whacenter-1'],  "081132214733", "", "https://ariefsan.crewbasproject.my.id/telegram/execution-3/download/". $filename);
  }
