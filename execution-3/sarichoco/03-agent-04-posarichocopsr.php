<?
// https://ariefsan.crewbasproject.my.id/telegram/execution-3/sarichoco/03-agent-04-posarichocopsr.php
...
if(mysqli_num_rows($exec) > 0) {
    ...
    // menampilkan hasil curl
  	$config["whacenterSendMessage"]($config['key-whacenter-1'], '085645488862' , $msg );
  	$config["whacenterSendMessage"]($config['key-whacenter-1'], '082228421911' , $msg );
