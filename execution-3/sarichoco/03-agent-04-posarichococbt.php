<?
// https://ariefsan.crewbasproject.my.id/telegram/execution-3/sarichoco/03-agent-04-posarichococbt.php
...
and po.selling_date > DATE_ADD(CURRENT_DATE(),interval 1 day)
and pod.quantity > 1
and p2.plant_id = 1
and po.sent_sap = 0
";
...
$msg = "*01-Agent (Order Sari Choco belum push SAP)* \n \n";
if(mysqli_num_rows($exec) > 0) {
    ...
    // menampilkan hasil curl
  	$config["whacenterSendMessage"]($config['key-whacenter-1'], '089602708946' , $msg );
  	$config["whacenterSendMessage"]($config['key-whacenter-1'], '081287912408' , $msg );
  	# $config["whacenterSendMessage"]($config['key-whacenter-1'], '082128511939' , $msg );
