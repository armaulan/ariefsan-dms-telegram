<?
// https://ariefsan.crewbasproject.my.id/telegram/execution-3/sarichoco/03-agent-04-posarichococku.php
...
if(mysqli_num_rows($exec) > 0) {
    ...
    // menampilkan hasil curl
  	$config["whacenterSendMessage"]($config['key-whacenter-1'], '081297755675' , $msg );
