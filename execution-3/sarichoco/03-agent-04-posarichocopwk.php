<?
// https://ariefsan.crewbasproject.my.id/telegram/execution-3/sarichoco/03-agent-04-posarichocopwk.php
...
if(mysqli_num_rows($exec) > 0) {
    ...
    // menampilkan hasil curl
  	$config["whacenterSendMessage"]($config['key-whacenter-1'], '087776014130' , $msg );
  	#$config["whacenterSendMessage"]($config['key-whacenter-1'], '082128511939' , $msg );
  	# $config["whacenterSendMessage"]($config['key-whacenter-1'], '082120792880' , $msg );
