<?
// https://ariefsan.crewbasproject.my.id/telegram/execution-3/03-dist-06-approvalsales.php
...
$msg = "*02-Dist (Flag SKU CHANEL DEVELOPMENT WARUNG)* \n";
$msg2 = " \n \n";
$total = 0 ;
...
# print($dataMessage);
$filename = substr(str_shuffle('0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'),1 , 4). "_flagsku_Sekolahnasional.txt";
...
$config["whacenterSendMessage"]($config['key-whacenter-1'], '081132214965', $msg . $msg2  );
  
if ($writeResult != false) {
  $config["whacentersenddoc"]($config['key-whacenter-1'],  "081132214965", "", "https://ariefsan.crewbasproject.my.id/telegram/execution-3/download/". $filename);
}
