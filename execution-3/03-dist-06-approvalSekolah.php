...
$msg = "*02-Dist (Flag SKU CHANEL DEVELOPMENT SEKOLAH)* \n";
$msg2 = " \n \n";
$total = 0 ;
...
# print($dataMessage);
$filename = substr(str_shuffle('0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'),1 , 4). "_flagsku_warungnasional.txt";
...
$writeResult = file_put_contents("download/". $filename, $dataMessage);
    ...
    # $config["whatsappSendMessage"]($config['key-wa-bas'],  $msg , $config['id-wa-riky'], "false");
     $config["whacenterSendMessage"]($config['key-whacenter-1'], '081132214971', $msg . $msg2  );
